...
<div class="alert alert-success">Settings updated</div>{/if}
<fieldset>
  <h2>Comment and Grade configurations</h2>
  <div class="panel">
  ...
  <form action="" method="post">
    ...
    <input class="btn btn-primary pull-right" type="submit" name="mymod_pc_form" value="Save" />
    </div>
  </form>
  </div>
</fieldset>
